...
export const searchPokeFetchSuccess = (res: PokeSpeciesType) =>
...
export const searchTypeFetchSuccess = (res: PokeSpeciesType) =>
...
export const searchPartnerFetchSuccess = (res: PokeSpeciesType) =>
