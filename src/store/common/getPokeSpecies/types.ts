// searchPoke
export const SEARCH_POKE_STARTED = "SEARCH_POKE/POKE_SPECIES/FETCH_STARTED";
export const SEARCH_POKE_SUCCESS = "SEARCH_POKE/POKE_SPECIES/FETCH_SUCCESS";
export const SEARCH_POKE_FAILED = "SEARCH_POKE/POKE_SPECIES/FETCH_FAILED";
