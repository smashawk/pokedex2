...
// type1
export const type1FetchStarted = (type: string) =>
	({ type: types.POKE_TYPE1_STARTED, payload: type } as const);
...
// type2
export const type2FetchStarted = (type: string) =>
	({ type: types.POKE_TYPE2_STARTED, payload: type } as const);
